...
void InterplotData(float *x_i, float *x_o, float *y_o, float *An, float *Bn, float *Cn, float *Dn, int(*FindPositionID)(float *x_i, float xn, int InputDataLen, float UserPara), float UserPara);


template <int InputDataLen>
void ConstractSplineLinearEquations(float *A, float *b, float *x_i, float *y_i);


template <int DataLen>
void SolveSplineEquations(float *A, float *b, float *x);
...
template <int InputDataLen, int OutputDataLen>
void SplineInterpolation(float *x_i, float *y_i, float *x_o, float *y_o, int(*FindPositionID)(float *x_i, float xn, int InputDataLen, float UserPara), float UserPara)
{
